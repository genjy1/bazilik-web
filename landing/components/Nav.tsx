...
export function Nav() {
   ...
   */
  useIsomorphicLayoutEffect(() => {
    const triggers = NAV_LINKS.map((link, i) => {
            ...
            {NAV_LINKS.map((l) => (
              <li key={l.href} data-menu-item>
                <a
                  ...
                  className="block rounded-xl px-3 py-2.5 font-mono text-[11px] uppercase tracking-[0.1em] text-muted transition-colors hover:bg-surface hover:text-accent-deep"
                >
                  {l.label}
                </a>
              </li>
