# Graph Report - landing  (2026-07-31)

## Corpus Check
- 107 files · ~125,756 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 690 nodes · 1005 edges · 46 communities (41 shown, 5 thin omitted)
...
Cohesion: 0.16
Nodes (14): AudienceLinks(), Problem(), Process(), Props, Step, ProofStrip(), AUDIENCE_ROUTES, FOOTER_GROUPS_ROOT (+6 more)
...
Cohesion: 0.13
Nodes (14): CheckItem, Hero(), JourneyBand(), NODES, PATH_D, playWhileVisible(), SHAPES, Button() (+6 more)
...
### Community 8 - "GoalsSection.tsx"
Cohesion: 0.14
Nodes (15): GoalsSection(), RING_FILL, HomePanel(), week, plans, ProsPanel(), Chip(), Tone (+7 more)

### Community 9 - "gsap.ts"
Cohesion: 0.08
Nodes (34): AmbientIngredients(), ITEMS, DishAssemblyScene(), Move, MOVES, SHOPPING, lerp(), lerp3() (+26 more)
...
Cohesion: 0.20
Nodes (10): BrandMark(), Footer(), FooterGroup, Nav(), NavLink, listeners, readTheme(), subscribe() (+2 more)
...
### Community 21 - "specialists/page.tsx"
Cohesion: 0.22
Nodes (11): metadata, ExistingClientsSection(), MarketplaceSection(), PainList(), COMPACT_CHAIN, SectionKicker(), Props, Reveal() (+3 more)
...
Cohesion: 0.17
Nodes (12): AudienceHero(), BasilikChain(), Props, CtaSection(), FinalCopy, BasilikToggleContext, BasilikToggleProvider(), BasilikToggleValue (+4 more)

### Community 27 - "home/page.tsx"
Cohesion: 0.18
Nodes (9): metadata, BackgroundFX(), BLOBS, ComparisonSection(), Row, Hypotheses(), FOOTER_GROUPS_HOME, HOME (+1 more)
...
### Community 33 - "PainChaos.tsx"
Cohesion: 0.29
Nodes (9): DinnerScene(), ExpiryScene(), OnionScene(), PainChaos(), ReceiptScene(), SCENES, TILTS, useLoopWhileVisible() (+1 more)
...
## Knowledge Gaps
- **382 isolated node(s):** `metadata`, `sans`, `mono`, `metadata`, `viewport` (+377 more)
...
- **Why does `MOTION_QUERIES` connect `gsap.ts` to `PainChaos.tsx`, `PlanConfigurator.tsx`, `Hero.tsx`, `GoalsSection.tsx`, `layout.tsx`, `EngineCards.tsx`, `Nav.tsx`, `CtaSection.tsx`, `home/page.tsx`?**
